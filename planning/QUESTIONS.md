...
| Should the first build support demo mode before full auth? | Architect / User | Before FlutterFlow implementation | Open | Demo mode may reduce auth dependency for first visual prototype. |
